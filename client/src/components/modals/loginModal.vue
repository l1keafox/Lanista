<template>
  <baseModal class="absolute top-0">
    ...
    <template v-slot:content>
      <div role="alert" class="container mx-auto w-[100rem] max-w-lg">
        ...
        <div class="flex flex-col text-sm rounded-md">
          <input class="mb-5 rounded-[4px] border p-3 hover:outline-none focus:outline-none hover:border-yellow-500 " type="text" placeholder="Username" v-model="username"/>
        ...
        <div class="mt-5 flex justify-around text-sm text-gray-600 w-full">
