...
onMounted(async ()=>{
      ...
      showTutorial({
				elementId: "pointsTut",
				message: "These stats are for battle, if any of these hits 0 you will lose your duel",
				orientation: "bottom",
			});
      showTutorial({
				elementId: "recordTut",
      ...
      showTutorial({
				...
				message: "This is physical stats, one of these is used in most offensive and defensive abilities",
				orientation: "bottom",
			});
      showTutorial({
				elementId: "mentalTut",
				message: "These determine your mental stats, while not as focused on physical, they are used in more abilities",
				orientation: "bottom",
			});
      showTutorial({
				elementId: "socialTut",
