  ...
  <BaseModal>
    ...
    <template v-slot:content>
      <div class="flex justify-around">
        ...
        <div
          class="w-[300px] flex flex-col justify-center items-center text-black"
        >
          <!-- {{ report[cIndex].R.r }}: -->
          {{
            report[cIndex].R.w == 1
    ...
    <template v-slot:footer>
      <h2 class="text-4xl text-black absolute left-0 ml-5">
        {{ cIndex }} / {{ report.k.rC }}
      </h2>
      ...
      <button :class="btnDecor" type="button" @click="backRound">
        &lt;&lt;
      </button>
      ...
      <button :class="btnDecor" type="button" @click="forwardRound">>></button>
