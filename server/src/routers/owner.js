        ...
        if (type === "items") {
          ...
          if (!struct) {
            console.log(
              "  -Missing>",
              ele.type,
              "structure not available, need to be created",
            );
          } else if (
            owner2.fame >= ele.fame &&
            owner2.structures.indexOf(ele.type) < 0
          ) {
