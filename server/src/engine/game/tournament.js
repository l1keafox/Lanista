...
async function doSaveTournament(members,report,saveAs,winner){
	...
	let savedTourny = await new saveTournament({tournament: JSON.stringify( report ),gladiators:gladiator, memories:memory, owners:owner, createdAt: parseInt(new Date()) });
