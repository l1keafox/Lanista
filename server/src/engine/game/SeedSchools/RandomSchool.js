...
const schoolName = "Random";
function makeSchedule() {
  // this guy does week, random
  let base = {
    1: getRandomFromArray(["lift", "yoga", "swim", "run", "hike", "jump"]),
    2: getRandomFromArray(["lift", "yoga", "swim", "run", "hike", "jump"]),
    3: getRandomFromArray(["lift", "yoga", "swim", "run", "hike", "jump"]),
    4: getRandomFromArray(["lift", "yoga", "swim", "run", "hike", "jump"]),
    5: getRandomFromArray(["lift", "yoga", "swim", "run", "hike", "jump"]),
    6: getRandomFromArray(["lift", "yoga", "swim", "run", "hike", "jump"]),
...
async function Seed() {
  ...
  console.log("  -EN> Starting to create ", 11, " gladiators");
  let allGladiators = await createNumGlads(11, newOwner);
  ...
  allGladiators.forEach((glad) => {
    ...
    glad.mainHand = getRandomFromArray(["gladius", "mace", "dagger"]);
