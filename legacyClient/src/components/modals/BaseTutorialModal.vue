<template>
  ...
  <div v-bind:="$attrs">
    ...
    <div
      id="info"
      class="cursor-disabled fixed text-black bg-white opacity-100 z-50"
    >
      <h1 v-if="tutMessage" class="m-2">{{ tutMessage }}</h1>
      <div class="flex">
        <button class="text-red-700 w-full bg-slate-300 m-2" @click="next">
          Next
        </button>
      </div>
    </div>
...
#window {
  ...
  box-shadow: 0 0 0 99999px rgba(220, 220, 220, 0.25);
}
</style>
